...
class DB_Functions {
    ...
    public function storeUser($name, $email, $password,$gcm_regid) {
        ...
        $salt = $hash["salt"]; // salt
        $result = mysql_query("INSERT INTO users(unique_id, name, email, encrypted_password, salt, created_at, gcm_regid) VALUES('$uuid', '$name', '$email', '$encrypted_password', '$salt', NOW(),'$gcm_regid')");
